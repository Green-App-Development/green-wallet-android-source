...
//    {'assetId':'nft133fm6pgen3mmqpwz6xg577fnxrzuxcr4k5696c7vqq456mc5k9aqd87ns6','amount':'1'},
     ...
     let id = ans['id']
     let offer = ans['offer']
    console.log("id from create offer method id = ",id)
    console.log("offer from create offer method offer = ",offer)
    });
}
...
function helperFunction3() {
 ...
 function helperFunction4(){
    console.log('Call from Android for checking connection');
     var textFieldValue = document.getElementById("myTextField").value;
     console.log("got url form text fields "+textFieldValue);
//     Bridge.interfaces.GreenWallet.loadNewUrl(textFieldValue).then((ans)) => {
//
//      };
 }
