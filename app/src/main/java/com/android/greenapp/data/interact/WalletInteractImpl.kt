...
class WalletInteractImpl @Inject constructor(
    ...
    private suspend fun convertWalletToWalletWithTokens(walletEntity: WalletEntity): WalletWithTokens {
        ...
        val hashWithIdWallet = walletEntity.hashWithIdWallet
        var hashListMutList = walletEntity.hashListImported.toMutableList()
        hashListMutList.add(0, "6d95dae356e32a71db5ddcb42224754a02524c615c5fc35f568c2af04774e589")
        hashListMutList.add(0, "1dd54162ec6423211556155fa455d4ed1a52ad305e6b5249eba50c91c8428dfb")
        ...
        for (hash in hashList) {
            ...
            val hashWalletId = hashWithIdWallet[hash] ?: 0
    ...
    override suspend fun checkIfMnemonicsExistInDB(mnemonics: List<String>,networkType: String): Optional<Boolean> {
