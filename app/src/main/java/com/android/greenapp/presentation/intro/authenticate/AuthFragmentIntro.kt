package com.android.greenapp.presentation.intro.authenticate
...
class AuthFragmentIntro : DaggerFragment() {
    ...
    private val binding by viewBinding(FragmentEnterPasswordIntroBinding::bind)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_enter_password_intro, container, false)
    }
        ...
        binding.txtClearCash.setOnClickListener {
            ...
            val btnConfirm = {
                introActViewModel.clearRoomDataStore() {
                    curActivity().move2GreetingActivity()
                }
            }
