                        ...
                        val resExchange = when (fromToken) {
                            "USDT" -> {
                                ExchangeRate(
                                    ...
                                    comission = res.fromUSDT.toXCH.usdtFee.usdt,
                                    xchFee = res.fromUSDT.toXCH.usdtFee.xch,
                                    usdtFee = res.fromUDT.toUSDT.usdtFee.usdt
                                )
                            }
                                ...
                                ExchangeRate(
                                    ...
                                    comission = res.fromXCH.toUSDT.xchFee.xch,
                                    xchFee = res.fromXCH.toUSDT.xchFee.xch,
                                    usdtFee = res.fromXCH.toUSDT.xchFee.usdt
                                )
                            }
                        }
