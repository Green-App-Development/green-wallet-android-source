...
interface TransactionDao {
    ...
    suspend fun updateTransactionStatusHeightNFTByTimeCreated(
        status: Status,
        height: Long,
        created_time: Long
    )
    ...
    @Query("DELETE FROM TransactionEntity WHERE transaction_id=:tranId")
    suspend fun deleteFromTransactionByTranID(tranId: String)
