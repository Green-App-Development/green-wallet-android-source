package extralogic.wallet.greenapp.presentation.onboard.time
...
class GreetingTimeFragment : Fragment(R.layout.fragment_time) {
    ...
    private fun changeGreetingTime() {
        ...
        val greetingTime = when {
            curMinutes in 0..extralogic.wallet.greenapp.presentation.tools.MORNING_STARTS_MINUTE -> curActivity().getStringResource(R.string.welcome_screen_titel_night)
            curMinutes in extralogic.wallet.greenapp.presentation.tools.MORNING_STARTS_MINUTE..extralogic.wallet.greenapp.presentation.tools.NOON_STARTS_MINUTE -> curActivity().getStringResource(
                R.string.welcome_screen_titel_morning
            )
            curMinutes in extralogic.wallet.greenapp.presentation.tools.NOON_STARTS_MINUTE..extralogic.wallet.greenapp.presentation.tools.EVENING_STARTS_MINUTE -> curActivity().getStringResource(
    ...
    private fun applyExtraBoldTypeFace() {
        ...
        val curMinutes = getCurrentTimeInMinutes()
        if (curMinutes in extralogic.wallet.greenapp.presentation.tools.NOON_STARTS_MINUTE..extralogic.wallet.greenapp.presentation.tools.EVENING_STARTS_MINUTE)
    ...
    private fun getMatchedImageResource(): Int {
        ...
        var res = when {
            curMinutes in 0..extralogic.wallet.greenapp.presentation.tools.MORNING_STARTS_MINUTE -> R.drawable.good_night
            curMinutes in extralogic.wallet.greenapp.presentation.tools.MORNING_STARTS_MINUTE..extralogic.wallet.greenapp.presentation.tools.NOON_STARTS_MINUTE -> R.drawable.good_morning
            curMinutes in extralogic.wallet.greenapp.presentation.tools.NOON_STARTS_MINUTE..extralogic.wallet.greenapp.presentation.tools.EVENING_STARTS_MINUTE -> R.drawable.good_day
