...
import com.green.compose.colors.colorPrimary
import com.green.compose.colors.colorRed
import com.green.compose.colors.colorSecondary
import com.green.compose.colors.colorYellow
import com.green.compose.colors.txtPrimaryColorsDark
import com.green.compose.colors.txtPrimaryColorsLight

@Immutable
data class CustomColorsPalette(
    val txtPrimaryColors: Color = Color.Unspecified,
...
val OnLightCustomColorsPalette = CustomColorsPalette(
    txtPrimaryColors = txtPrimaryColorsLight,
    primaryAppBackground = Color(0xFFF4F4F4)
)

val OnDarkCustomColorsPalette = CustomColorsPalette(
    txtPrimaryColors = txtPrimaryColorsDark,
